; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\skinny\projects\lightspark\zlib-1.2.5\inftrees.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\skinny\projects\lightspark\zlib-1.2.5\inftrees.c
...
; 254  :         if (--(count[len]) == 0) {
	...
	test	ecx, ecx
	jne	SHORT $LN17@inflate_ta

; 255  :             if (len == max) break;

	mov	eax, DWORD PTR _len$[ebp]
	cmp	eax, DWORD PTR _max$[ebp]
	jne	SHORT $LN16@inflate_ta
	jmp	$LN29@inflate_ta
$LN16@inflate_ta:
...
; 281  :                 (type == DISTS && used >= ENOUGH_DISTS))
	...
	cmp	DWORD PTR _used$[ebp], 852		; 00000354H
	jae	SHORT $LN9@inflate_ta
$LN8@inflate_ta:
	cmp	DWORD PTR _type$[ebp], 2
	jne	SHORT $LN10@inflate_ta
	cmp	DWORD PTR _used$[ebp], 592		; 00000250H
	jb	SHORT $LN10@inflate_ta
$LN9@inflate_ta:
