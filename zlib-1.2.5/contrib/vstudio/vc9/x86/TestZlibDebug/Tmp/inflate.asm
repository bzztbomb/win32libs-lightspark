; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.21022.08 
	...
	TITLE	c:\Open Source\zlib-1.2.5\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\open source\zlib-1.2.5\inflate.c
...
; 1232 :                       (state->mode == LEN_ || state->mode == COPY_ ? 256 : 0);
	...
	je	SHORT $LN518@inflate
	mov	DWORD PTR tv1334[ebp], 0
	jmp	SHORT $LN519@inflate
$LN518@inflate:
	mov	DWORD PTR tv1334[ebp], 256		; 00000100H
$LN519@inflate:
	mov	edx, DWORD PTR _state$[ebp]
