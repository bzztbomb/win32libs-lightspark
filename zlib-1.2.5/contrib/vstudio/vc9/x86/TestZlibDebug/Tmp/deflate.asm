; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.21022.08 
	...
	TITLE	c:\Open Source\zlib-1.2.5\deflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\open source\zlib-1.2.5\deflate.c
...
tv286 = -108						; size = 4
tv190 = -108						; size = 4
_bstate$77895 = -40					; size = 4
_val$77869 = -36					; size = 4
_beg$77868 = -32					; size = 4
_val$77856 = -28					; size = 4
_beg$77855 = -24					; size = 4
_beg$77843 = -20					; size = 4
_level_flags$77829 = -16				; size = 4
_header$77828 = -12					; size = 4
_s$ = -8						; size = 4
_old_flush$ = -4					; size = 4
_strm$ = 8						; size = 4
_flush$ = 12						; size = 4
...
; 655  :             uInt header = (Z_DEFLATED + ((s->w_bits-8)<<4)) << 8;
	...
	add	ecx, 8
	shl	ecx, 8
	mov	DWORD PTR _header$77828[ebp], ecx
...
; 659  :                 level_flags = 0;
	...
	mov	DWORD PTR _level_flags$77829[ebp], 0
...
; 661  :                 level_flags = 1;
	...
	mov	DWORD PTR _level_flags$77829[ebp], 1
	jmp	SHORT $LN68@deflate
$LN67@deflate:
...
; 663  :                 level_flags = 2;
	...
	mov	DWORD PTR _level_flags$77829[ebp], 2
...
; 665  :                 level_flags = 3;
	...
	mov	DWORD PTR _level_flags$77829[ebp], 3
$LN68@deflate:

; 666  :             header |= (level_flags << 6);

	mov	eax, DWORD PTR _level_flags$77829[ebp]
	shl	eax, 6
	or	eax, DWORD PTR _header$77828[ebp]
	mov	DWORD PTR _header$77828[ebp], eax
...
; 667  :             if (s->strstart != 0) header |= PRESET_DICT;
	...
	mov	eax, DWORD PTR _header$77828[ebp]
	or	eax, 32					; 00000020H
	mov	DWORD PTR _header$77828[ebp], eax
$LN63@deflate:
...
; 668  :             header += 31 - (header % 31);
	...
	sub	eax, edx
	add	eax, DWORD PTR _header$77828[ebp]
	mov	DWORD PTR _header$77828[ebp], eax
...
; 684  :             uInt beg = s->pending;  /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$77843[ebp], ecx
$LN59@deflate:
...
; 688  :                     if (s->gzhead->hcrc && s->pending > beg)
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$77843[ebp]
...
; 690  :                                             s->pending - beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$77843[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$77843[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 712  :             uInt beg = s->pending;  /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$77855[ebp], ecx
$LN49@deflate:
...
; 717  :                     if (s->gzhead->hcrc && s->pending > beg)
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$77855[ebp]
...
; 719  :                                             s->pending - beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$77855[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$77855[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 723  :                         val = 1;
	...
	mov	DWORD PTR _val$77856[ebp], 1
...
; 727  :                 val = s->gzhead->name[s->gzindex++];
	...
	mov	DWORD PTR _val$77856[ebp], edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
...
; 728  :                 put_byte(s, val);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	dl, BYTE PTR _val$77856[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	add	ecx, 1
...
; 729  :             } while (val != 0);
	...
	cmp	DWORD PTR _val$77856[ebp], 0
	jne	$LN49@deflate
$LN47@deflate:
...
; 743  :             uInt beg = s->pending;  /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$77868[ebp], ecx
$LN38@deflate:
...
; 748  :                     if (s->gzhead->hcrc && s->pending > beg)
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$77868[ebp]
...
; 750  :                                             s->pending - beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$77868[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$77868[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 754  :                         val = 1;
	...
	mov	DWORD PTR _val$77869[ebp], 1
...
; 758  :                 val = s->gzhead->comment[s->gzindex++];
	...
	mov	ecx, DWORD PTR [eax+32]
	movzx	edx, BYTE PTR [edx+ecx]
	mov	DWORD PTR _val$77869[ebp], edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
...
; 759  :                 put_byte(s, val);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	dl, BYTE PTR _val$77869[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	add	ecx, 1
...
; 760  :             } while (val != 0);
	...
	cmp	DWORD PTR _val$77869[ebp], 0
	jne	$LN38@deflate
$LN36@deflate:
...
$LN97@deflate:
	...
	mov	DWORD PTR _bstate$77895[ebp], eax

; 823  : 
; 824  :         if (bstate == finish_started || bstate == finish_done) {

	cmp	DWORD PTR _bstate$77895[ebp], 2
	je	SHORT $LN16@deflate
	cmp	DWORD PTR _bstate$77895[ebp], 3
...
; 827  :         if (bstate == need_more || bstate == finish_started) {
	...
	cmp	DWORD PTR _bstate$77895[ebp], 0
...
; 840  :         if (bstate == block_done) {
	...
	cmp	DWORD PTR _bstate$77895[ebp], 1
	jne	$LN19@deflate
...
tv149 = -96						; size = 4
tv138 = -96						; size = 4
_init$78029 = -28					; size = 4
_curr$78027 = -24					; size = 4
_wsize$ = -20						; size = 4
_more$ = -16						; size = 4
_p$ = -12						; size = 4
_m$ = -8						; size = 4
...
; 1405 :         ulg curr = s->strstart + (ulg)(s->lookahead);
	...
	mov	edx, DWORD PTR _s$[ebp]
	add	ecx, DWORD PTR [edx+116]
	mov	DWORD PTR _curr$78027[ebp], ecx
...
; 1408 :         if (s->high_water < curr) {
	...
	cmp	ecx, DWORD PTR _curr$78027[ebp]
...
; 1412 :             init = s->window_size - curr;
	...
	sub	ecx, DWORD PTR _curr$78027[ebp]
	mov	DWORD PTR _init$78029[ebp], ecx

; 1413 :             if (init > WIN_INIT)

	cmp	DWORD PTR _init$78029[ebp], 258		; 00000102H
	jbe	SHORT $LN4@fill_windo

; 1414 :                 init = WIN_INIT;

	mov	DWORD PTR _init$78029[ebp], 258		; 00000102H
$LN4@fill_windo:

; 1415 :             zmemzero(s->window + curr, (unsigned)init);

	mov	eax, DWORD PTR _init$78029[ebp]
	push	eax
	push	0
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+56]
	add	edx, DWORD PTR _curr$78027[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 1416 :             s->high_water = curr + init;
	...
	mov	eax, DWORD PTR _curr$78027[ebp]
	add	eax, DWORD PTR _init$78029[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
; 1423 :             init = (ulg)curr + WIN_INIT - s->high_water;
	...
	mov	DWORD PTR _init$78029[ebp], eax
...
; 1424 :             if (init > s->window_size - s->high_water)
	...
	cmp	DWORD PTR _init$78029[ebp], edx
...
; 1425 :                 init = s->window_size - s->high_water;
	...
	mov	edx, DWORD PTR [eax+60]
	sub	edx, DWORD PTR [ecx+5824]
	mov	DWORD PTR _init$78029[ebp], edx
$LN1@fill_windo:
...
; 1427 :             s->high_water += init;
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5824]
	add	ecx, DWORD PTR _init$78029[ebp]
	mov	edx, DWORD PTR _s$[ebp]
...
; 1564 :                            s->match_length - MIN_MATCH, bflush);
	...
	mov	ax, WORD PTR _dist$78094[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$78094[ebp], ax
	movzx	eax, BYTE PTR _len$78093[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$78093[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$78094[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN20@deflate_fa
	movzx	ecx, WORD PTR _dist$78094[ebp]
...
; 1600 :             _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$78102[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
_cc$78161 = -22						; size = 1
_cc$78151 = -21						; size = 1
_dist$78136 = -20					; size = 2
_len$78135 = -13					; size = 1
_max_insert$78134 = -12					; size = 4
_bflush$ = -8						; size = 4
_hash_head$ = -4					; size = 4
_s$ = 8							; size = 4
_flush$ = 12						; size = 4
...
; 1677 :             uInt max_insert = s->strstart + s->lookahead - MIN_MATCH;
	...
	mov	DWORD PTR _max_insert$78134[ebp], ecx
...
; 1683 :                            s->prev_length - MIN_MATCH, bflush);
	...
	sub	ecx, 3
	mov	BYTE PTR _len$78135[ebp], cl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+108]
	sub	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	sub	ecx, DWORD PTR [edx+100]
	mov	WORD PTR _dist$78136[ebp], cx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5796]
	mov	dx, WORD PTR _dist$78136[ebp]
	mov	WORD PTR [eax+ecx*2], dx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5784]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	dl, BYTE PTR _len$78135[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	mov	ax, WORD PTR _dist$78136[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$78136[ebp], ax
	movzx	eax, BYTE PTR _len$78135[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$78135[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$78136[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN26@deflate_sl
	movzx	ecx, WORD PTR _dist$78136[ebp]
	movzx	edx, BYTE PTR __dist_code[ecx]
...
; 1693 :                 if (++s->strstart <= max_insert) {
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+108]
	cmp	ecx, DWORD PTR _max_insert$78134[ebp]
	ja	$LN12@deflate_sl
...
; 1709 :             _tr_tally_lit(s, s->window[s->strstart-1], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$78151[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$78151[ebp]
...
; 1728 :         _tr_tally_lit(s, s->window[s->strstart-1], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$78161[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$78161[ebp]
...
tv210 = -96						; size = 4
_cc$78194 = -25						; size = 1
_dist$78192 = -24					; size = 2
_len$78191 = -17					; size = 1
_strend$ = -16						; size = 4
_scan$ = -12						; size = 4
_prev$ = -8						; size = 4
_bflush$ = -4						; size = 4
...
; 1785 :             _tr_tally_dist(s, 1, s->match_length - MIN_MATCH, bflush);
	...
	mov	ecx, DWORD PTR [eax+96]
	sub	ecx, 3
	mov	BYTE PTR _len$78191[ebp], cl
	mov	eax, 1
	mov	WORD PTR _dist$78192[ebp], ax
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5796]
	mov	dx, WORD PTR _dist$78192[ebp]
	mov	WORD PTR [eax+ecx*2], dx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5784]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	dl, BYTE PTR _len$78191[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	mov	ax, WORD PTR _dist$78192[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$78192[ebp], ax
	movzx	eax, BYTE PTR _len$78191[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$78191[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$78192[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN20@deflate_rl
	movzx	ecx, WORD PTR _dist$78192[ebp]
	movzx	edx, BYTE PTR __dist_code[ecx]
...
; 1793 :             _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$78194[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$78194[ebp]
...
; 1827 :         _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$78219[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$78219[ebp]
